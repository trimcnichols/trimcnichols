...
- 🚀  Click the :blossom: :snake: ☕ :penguin: to see the code and explanation about my code
  ...
  |  |  | [Active Directory, Installation step by step](https://petri.com/install-active-directory-users-and-computers/#How_to_open_Active_Directory_Users_and_Computers)
  |  |  | [windows server documentation](https://learn.microsoft.com/en-us/troubleshoot/windows-server/welcome-windows-server)
